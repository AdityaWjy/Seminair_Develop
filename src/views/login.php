    ...
    <div class="container d-flex align-items-center justify-content-center min-vh-100">
        <div class="card p-4 shadow-lg" style="max-width: 400px; width: 100%;">
            ...
            <form action="../Controller/LoginController.php" method="POST">
                ...
                <button type="submit" class="btn w-100 button-gradient">Login</button>
            </form>
            <p class="mt-4 text-left text-white-50" style="font-size: 0.9rem;">
                Belum mempunyai akun?
                <a href="./register.php" class="text-decoration-none " style="color: #ec4899; font-weight: 600;">Sign Up</a>
            </p>
        </div>
    </div>
