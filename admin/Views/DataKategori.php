    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <p>Ini adalah area data kategori Anda. Anda bisa melihat kategori di sini.</p>
                        ...
                        <tbody>
                            <?php if (!empty($listKategori)) : ?>
                                ...
                                <?php foreach ($listKategori as $category) : ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td><?= htmlspecialchars($category['nama_kategori'], ENT_QUOTES, 'UTF-8') ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else : ?>
                                <tr>
                                    <td colspan="2">Tidak ada kategori tersedia.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
